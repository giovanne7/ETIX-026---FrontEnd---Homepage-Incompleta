...
export function RecoverPasswordForm({ onSwitchForm }: RecoverPasswordFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="recover-email" className="block text-sm font-medium text-gray-700">Email</label>
